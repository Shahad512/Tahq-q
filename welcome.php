...
require_once('include/question_submit.php');  
...
<h1 class="text-white H3 pb-4">WELCOME</h1>
        ...
        <div class="col-md-12 mb-4">
            ...
            <div class="site_welcome_box text-white ">
                ...
                <div class="col-lg-6">
                    ...
                    <li><a href="#" class="btn btn-success btn-block" data-toggle="modal" data-target="#askques">ASK QUESTION</a></li>
                    </ul>
