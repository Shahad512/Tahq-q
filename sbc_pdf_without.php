...
mysqli_query($conn, "insert into sbc_user set user_id = '$user' , pdf_type='without'");
    
    add_activity($conn,"SBC Service without reference");
...
$html .=  '<td align="left" width="45%"  style="border :  1px #CCC solid;padding:10px;">'.$row['title'].'</td>';
$html .=  '<td align="left" width="50%"  style="border :  1px #CCC solid;padding:10px;">'.$row['detail'].'</td>';
...
$html .=  '<tr>';
$html .=  '<td align="left" width="5%" style="border :  1px #CCC solid;padding:10px;">'.$i.'</td>';
$html .=  '<td align="left" width="95%"  style="border :  1px #CCC solid;padding:10px;">'.$row['title'].'</td>';
    $html .=  '<td align="left" width="45%"  style="border :  1px #CCC solid;padding:10px;">'.$row['detail'].'</td>';
